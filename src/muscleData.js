const muscleData = {
	...
	"113": {
		"name": "Kinnikuman Super Phoenix(A)",
		"classes": {
			"A": ["R", "S"],
			"B": ["G", "L", "O"],
			"C": ["F", "B", "M"]
	...
	"153": {
		"name": "Sunigator Shotai (The Claw)",
		"classes": {
			"A": ["P"],
			"B": ["R", "S"],
			"C": ["F", "G", "B", "L", "O"]
	...
	"229": {
		"name": "Kinnikuman Super Phoenix(B)",
		"classes": {
			"B": ["R", "S", "B", "O", "M"],
			"C": ["F", "P"]
		}
